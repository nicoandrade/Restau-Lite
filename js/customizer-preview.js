	...
	wp.customize( 'restau_lite_welcome_image', function( value ) {
		value.bind( function( to ) {
			if ( to != "" ) {
				...
				$( '.welcome-image' ).css( 'background-image', 'url(' + wp_customizer.theme_url + "/images/welcome.jpg)" );
			}
		} );
	} );
	//Background Image
	wp.customize( 'restau_lite_welcome_logo_image', function( value ) {
		value.bind( function( to ) {
			if ( to != "" ) {
				...
				$( '.welcome-image img' ).attr( 'src', wp_customizer.theme_url + "/images/logo_big.png" );
			}
		} );
	} );
		...
		wp.customize( 'restau_lite_gallery_image', function( value ) {
			value.bind( function( to ) {
				if ( to != "" ) {
					...
					$( '.gallery-section .gallery-image' ).css( 'background-image', 'url(' + wp_customizer.theme_url + "/images/gallery.jpeg)" );
				}
			} );
		} );
	...
	wp.customize( 'restau_lite_bottom_image', function( value ) {
		value.bind( function( to ) {
			if ( to != "" ) {
				...
				$( '.bottom-image' ).css( 'background-image', 'url(' + wp_customizer.theme_url + "/images/footer_bck.jpg)" );
			}
		} );
	} );
